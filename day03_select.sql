...
-- Ilk yöntem
SELECT * FROM ogretmen_lisesi
WHERE sinav_notu BETWEEN 71 AND 79; -- Between kosulunda önce kucuk olan degeri yazmaliyiz
...
SELECT isim FROM ogretmen_lisesi
WHERE isim BETWEEN 'Muhammet  Talha' and 'Murat'; -- sadece Muhammet Talha Kurt geldi...
...
USE sys;
SELECT isim FROM ogretmen_lisesi
WHERE adres BETWEEN 'Ankara' and 'Corum';
...
---------------------------------------------------------------------------*/
SELECT * FROM personel
WHERE id BETWEEN '10005' AND '10009'; -- Tirnak ile sorgulayinca siralayip gönderiyor. Tirnak olmadan ise tablodaki yerine göre yukaridan asagiya gösteriyor.
...
SELECT * FROM personel
WHERE isim BETWEEN 'Mehmet Yilmaz' AND 'Veli'; -- '' icinde fazladan bosluk kullanirsak SQL bunu algilamaz

 /*-------------------------------------------------------------------------
Q12: Ismi Ahmet ile Ayse Cano arasinda olan personel bilgilerini listeleyin
---------------------------------------------------------------------------*/
SELECT * FROM personel
WHERE isim BETWEEN 'Ahmet' AND 'Ayse Cano';

/*-------------------------------------------------------------------------
Q13: Maasi 7000 ya da ismi Ayse olan personel id'lerini listeleyin
---------------------------------------------------------------------------*/
SELECT id FROM personel
WHERE maas = 7000 OR isim = 'Ayse'; -- OR yerine || da kullanilabilir
