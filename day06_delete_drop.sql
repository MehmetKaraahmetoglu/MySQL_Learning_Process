...
SAVEPOINT armut; -- bu komutu calistirdigimiz anda Database'imizin bir yedegini almis oluyoruz

ROLLBACK TO armut; -- bu komutla yaptigimiz degisiklikleri Savepoint elma anindaki duruma geri dondurduk.
...
/* ============================= DELETE - TRUNCATE - DROP ================================   
  ...
  1-) TRUNCATE komutu DELETE komutu gibi bir tablodaki verilerin tamamini siler. Tüm savepointleri de siler.
