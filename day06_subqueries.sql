...
-- 2. Adim : Ford ve Toyota'da calisan personeli sirket isimleriyle listeleyin
SELECT isim, sirket
FROM calisanlar
WHERE sirket IN ('Ford','Toyota');

-- 3. Adim : Iki sorguyu birlestirelim
SELECT isim, sirket
FROM calisanlar
...
/*----------------------------------------------------------------
 ...
 sirketlerini, maaslarini ve sehirlerini listeleyiniz
----------------------------------------------------------------*/
...
-- Calisanlar tablosuna Volkwagen sirketinde calisan bir personel ekleyelim 
 
insert into calisanlar values(123654789, 'Beyza Nergiz','Istanbul',9000, 'Volkswagen'); 
